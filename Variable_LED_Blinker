...
void loop() {
  digitalWrite(ledPin, HIGH); //when the pin is switched to high, it turns on the LED
  ...
  digitalWrite(ledPin, LOW); //when the pin is switched to low, it turns off the LED
  delay(250);
}
